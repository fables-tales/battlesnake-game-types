...
pub type StandardCellBoard<T, const BOARD_SIZE: usize, const MAX_SNAKES: usize> = standard::CellBoard<T, BOARD_SIZE, MAX_SNAKES>;
...
pub type WrappedCellBoard<T, const BOARD_SIZE: usize, const MAX_SNAKES: usize> = wrapped::CellBoard<T, BOARD_SIZE, MAX_SNAKES>;
